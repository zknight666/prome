	...
	public void makePagingHTML() {
		...
		for(int i=startPage; i<=endPage; i++) {
			if(i==currentPage)
				...
				.append("<a class='page-link' id='currentPaging' onclick='projectPaging(" + i + ")'>" + i + "</a>")
				.append("</li>");
			else
				pagingHTML
				.append("<li class='page-item'>")
				.append("<a class='page-link' id='paging' onclick='projectPaging(" + i + ")'>" + i + "</span>")
				.append("</li>");
		}
		...
		if(endPage < totalP)
			pagingHTML
			.append("<li class='page-item'>")
			.append("<a class='page-link' id='paging' onclick='projectPaging(" + (endPage+1) + ")'>&raquo;</a>");	
	}
