        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarColor03">
            ...
            <form class="d-flex dropdown">
              ...
              <button
                class="btn my-2 my-sm-0 nav-link dropdown-toggle"
                aria-haspopup="true"
                aria-expanded="false"
              ...
              <div class="dropdown-menu" style="right: 0">
                ...
                <a class="dropdown-item" id="userinfoBtn" href="/prome/users/userinfo"
                  >회원 정보 수정</a
                >
                <div class="dropdown-divider"></div>
              </div>
              ...
              <div class="section">
                <div class="p-2">
                  ...
                  <div class="p-4">
                    ...
                    <div class="project_namebox">
                      <input
                        name="project_name"
                        required="required"
                        placeholder="3~20글자로 적어주세요 예)승차거부 신고앱"
                        minLength="3"
                        maxLength="20"
                        value=""
                        autoComplete="on" />
                    ...
                    <div>
                      ...
                      <div class="row mb-3" id="recruitContainer">
                        <div class="recruit" style="display: flex; align-items: center">
                          ...
                          <div class="plusMinusBtnWrap">
                            &emsp;
                            <img
                              class="imageBtnminus"
                              alt=""
                              src="../assets/images/imageBtnminus.png" />
                            <input
                              type="text"
                              class="recruit_countNumber"
                              name="recruit_count_0"
                              value="1"
                              readonly="readonly" />
                            <img
                              class="imageBtnplus"
                              alt=""
                              src="../assets/images/imageBtnplus.png" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="flex btn-position recruitbtn">
                        ...
                        <button type="button" class="btn btn-outline-dark mx-3 recruit_minus">
                          삭제
                        </button>
                        <button type="button" class="btn btn-outline-dark recruit_plus">
                          추가
                        </button>
                      </div>
                    </div>
                      ...
                      <div
                        ...
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >&nbsp;(ex - 국내여행을 가려고 하는데 어떤곳이 좋은지에 대한 경험이
                            없어서 어려웠습니다.)&nbsp;</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">
                        ...
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >&nbsp;(ex - 계절별/축제별 국내여행을 모아서 추천해주는 서비스를
                            만들고자합니다.)&nbsp;</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">
                        ...
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >&nbsp;(ex - 혼자 여행하는 것에 꺼리낌이 없는 30대 이상의 미혼 남녀를
                            대상으로 합니다)&nbsp;</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">&nbsp;</p>
                        ...
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >&nbsp;(ex - 1주일에 1회/2회 정도 정기적으로 회의합니다)</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">
                        ...
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >&nbsp;(ex - 온라인은 줌을 활용하고, 오프라인은 강남역 카페등을
                            대관할예정입니다, 커뮤니케이션은 슬랙을 위주로 사용합니다 )</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">&nbsp;</p>
                        ...
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >-&nbsp; 2번까지의 내용을 포함할 수 있도록 작성해주세요(형식은 달라도
                            상관없습니다)</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >-&nbsp; 신청시 기타사항과 질문내용 등을 삭제한 후 답변만
                            등록해주세요.&nbsp;</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >&nbsp; (그외의 내용은 자유롭게 기입해주세요(영상/이미지
                            포함)&nbsp;</span
                          >
                        </p>
                        <p style="font-size: 14px; line-height: 21px">
                          <span style="color: rgb(156, 156, 148)"
                            >-&nbsp; 상세 검수가이드라인은 공지사항을 참고해주세요. </span
                          ><a
                            target="_blank"
                            rel="noopener noreferrer nofollow"
                            style="text-decoration: underline"
                            href="https://letspl.me/notice/80"
                            ><span style="color: rgb(156, 156, 148)"
                              >https://letspl.me/notice/80</span
                            ></a
                          >
                        </p>
                      </div>
                  ...
                  <div class="p-4">
                    ...
                    <div class="flex space-x-5">
                      <div style="padding-right: 20px">
                        <label for="start-date" class="block text-xl mb-2"
                          >&nbsp;프로젝트 시작 기간&nbsp;</label
                        >
                        <input
                          type="date"
                      ...
                      <div>
                        <label for="end-date" class="block text-xl mb-2"
                          >&nbsp;프로젝트 종료 기간&nbsp;</label
                        >
                        <input
                          type="date"
                  ...
                  <div class="pb-4 flex btn-position">
                    <button type="button" id="tempSaveBtn" class="btn btn-outline-dark mx-3">
                      임시저장
                    </button>
